...
const TopUpSuccess = ({navigation}) => {
    ...
    <View style={{backgroundColor: 'white'}}>
        ...
        <View>
            <Text style={{color: 'black',fontSize:30,fontWeight:'500', marginHorizontal: 50}}>Top Up Complete</Text>
        </View>
        <View>
        ...
        <View style={{marginHorizontal:40,marginTop: 8,backgroundColor: '#2C5FB8',flexDirection:'column', borderRadius:10}}>
            ...
            <View>
                <Text style={{marginHorizontal: 120,fontWeight:'500'}}>VA mandiri</Text>
            </View>
